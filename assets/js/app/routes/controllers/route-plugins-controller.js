...
(function () {
  ...
  angular.module('frontend.routes')
    .controller('RoutePluginsController', [
      '_', '$scope', '$stateParams', '$log', '$state', 'RoutesService', 'PluginsService', '$uibModal', 'DialogService',
      function controller(_, $scope, $stateParams, $log, $state, RoutesService, PluginsService, $uibModal, DialogService) {
