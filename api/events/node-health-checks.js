...
module.exports = {
  ...
  makePlainTextNotification: function makePlainTextNotification(node) {
    ...
    return {
      text: `Kong Node Health Check Failed: *${node.name}*`,
      blocks: [
        {
          "type": "header",
          "text": {
            "type": "plain_text",
            "text": "Kong Node Health Check Failed"
          }
        },
        {
          "type": "section",
          "fields": [
            ...
            {
              "type": "mrkdwn",
              "text": `*Motivo:*\n${_.get(tasks, `${node.id}.lastFailedReason`, 'N/A')}`
            }
          ]
        },
        {
        ...
        },
        {
          ...
          "elements": [
            {
              "type": "mrkdwn",
              "text": "Verifique a conectividade e status do nó Kong"
            }
          ]
        }
      ]
